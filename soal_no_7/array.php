...
<body>
    ...
    <?php
    echo "<h3>contoh 1</h3>";
    $trainer = ["alam", "ilham", "farahan", "bintang"];
    print_r($trainer);
    ...
    echo "<h3>contoh 3</h3>";
    $biodata = [
        ["name" => "alam", "umur" =>  17, "materi" => "laravel1", " Aliases" => "Will the Wise"],
        ["name" => "ilham", "umur" => 18, "materi" => "paython", " Aliases" => "Will the Wise"],
        ["name" => "bintang", "umur" => 19, "materi" => "Digital Marketing", " Aliases" => "Will the Wise"],
    ];
